...
%TARIFFWAR.ELASTICITY.REGISTRY  Master registry of all elasticity sources.
%
...
%
%   See also: tariffwar.elasticity.get, tariffwar.elasticity.list_sources
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.uniform_simonovska_waugh;
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.caliendo_parro_2015;
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.bagwell_staiger_yurukoglu_2021;
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.giri_yi_yilmazkuday_2021;
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.shapiro_2016;
    ...
    reg(idx).implemented    = true;
    reg(idx).getter         = @tariffwar.elasticity.sources.fontagne_2022;
