...
%   See also: tariffwar.data.build_cubes
    ...
    % --- Find the CSV ---
    search_paths = { ...
        fullfile(cfg.data_root, 'icio', sprintf('%d.csv', year)); ...
        fullfile(cfg.data_root, 'icio', sprintf('%d_SML.csv', year)); ...
        fullfile(cfg.data_root, 'icio', sprintf('ICIO2023_%d.csv', year))};
