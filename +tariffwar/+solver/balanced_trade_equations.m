...
%TARIFFWAR.SOLVER.BALANCED_TRADE_EQUATIONS  System of equations for balanced trade (D=0).
%
...
% ------------------------------------------------------------------
%
%   See also: tariffwar.data.balance_trade, tariffwar.solver.nash_equations
